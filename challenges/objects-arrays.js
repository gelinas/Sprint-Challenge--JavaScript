...
// Create a new roar method for the tyrannosaurus.  When called, return  Log the result.
...
*/
let totalAnimals = ((accumulator, animal) => accumulator + animal.population);
const populationTotal = zooAnimals.reduce(totalAnimals, 0);
